...
export const home = {
  hero: {
    ...
    plate: { illo: "atelier", caption: "Un angolo d'atelier" },
  },
 ...
 * la struttura del dato non cambia (title, place, year, mix, illo, text).
 * `illo` e' il nome del simbolo in components/vittoria/Illustrations.jsx —
 * quando arriva la foto vera, passa `src` a <Plate> al posto di `illo`.
 */
export const works = [
  {
...
export const pages = {
  progetto: {
    ...
    plateIllo: "plan",
    plateCaption: "Ogni progetto parte da qui",
    sections: [
      {
  ...
  contract: {
    ...
    plateIllo: "suite",
    plateCaption: "Il comfort di una camera, ovunque",
    sections: [
      {
  ...
  architetti: {
    ...
    plateIllo: "study",
    plateCaption: "Il tavolo di lavoro condiviso",
    sections: [
      {
